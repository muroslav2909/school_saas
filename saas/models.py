...
class Task(models.Model):
    ...
    task_exp_start_date = models.CharField(max_length=500, null=True, blank=True)
    task_exp_end_date = models.CharField(max_length=500, null=True, blank=True)
    task_actual_start_date = models.CharField(max_length=500, null=True, blank=True)
    task_actual_end_date = models.CharField(max_length=500, null=True, blank=True)
...
class Expenses(models.Model):
    ...
    expense_date = models.CharField(max_length=50, null=True, blank=True)
    expense_amount = models.CharField(max_length=20, null=True, blank=True)
    created = models.DateTimeField(auto_now_add=True)
...
class Child(models.Model):
    ...
    school = models.ForeignKey(School, default=None, null=True, blank=True)
    created = models.DateTimeField(auto_now_add=True, null=True, blank=True)
    updated = models.DateTimeField(auto_now=True, null=True, blank=True)
